        ...
        <div className='flex-auto pr3 lh-copy charcoal'>
          <Box>
            ...
            <Trans i18nKey='configureApiPort.paragraph1'>
              <p>If your OTFS node is configured with a <a className='link blue' href='https://github.com/ipfs/go-ipfs/blob/master/docs/config.md#addresses' target='_blank' rel='noopener noreferrer'>custom API address</a>, please set it here</p>
            </Trans>
            <ApiAddressForm
              t={t}
    ...
    return (
      <div>
        ...
        <Trans i18nKey='connected.paragraph2'>
          <p>You can always come back to this address to change the OTFS node you're connected to.</p>
        </Trans>
      </div>
    )
  }
